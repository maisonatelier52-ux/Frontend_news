...
export default function LegalPolicyPage() {
  ...
  const leadParagraph = config?.leadParagraph || 'This document contains the legal disclosures and policy guidelines governing your use of the **Magazine Gazette** website and digital services.';
