        ...
        >
          ...
          >
            ...
            {columns.slice(4).map((col) => {
              ...
              return (
                <div key={col.id} className="lg:col-span-2 text-left">
                  {col.heading && (
                    <h5 
                      style={{ color: textColorSecondary }}
                      className="text-[10px] font-extrabold uppercase tracking-widest mb-4 font-sans"
          ...
          >
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <a href="https://www.instagram.com/magazinegazette367/" target="_blank" rel="noopener noreferrer" title="Instagram" style={{ color: textColorSecondary }} className="hover:opacity-100 opacity-70 transition-all p-1 flex items-center justify-center">
