  ...
  return (
    <div className="max-w-[1150px] animate-[admin-fade-in_0.4s_ease_both] pb-12">
      <div className="flex justify-between items-start mb-6">
        <div>
          <h1 className="text-[22px] font-sans font-extrabold text-[#111] m-0">Terms & Conditions Manager</h1>
          <p className="text-[12.5px] text-slate-500 mt-1 font-medium">Manage and change the core terms and restrictions dynamically.</p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.01)] space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest block">Terms & Rules Sections</span>
            ...
            {sections.length === 0 ? (
              <div className="text-center text-slate-400 text-xs py-8 font-sans border border-dashed border-slate-200 rounded-lg">
                No terms sections added yet. Click "+ Add Terms Section".
              </div>
            ) : (
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.01)] sticky top-6 space-y-4">
            ...
            <div className="border border-slate-150 rounded-lg p-4 bg-white font-sans max-h-[600px] overflow-y-auto space-y-4 select-none">
              <div className="pb-3 border-b border-slate-100">
                <h2 className="font-serif text-lg font-bold text-slate-900 leading-tight">{title || 'Terms and Conditions'}</h2>
              ...
              {sections.map((sec, idx) => (
                <div key={idx} className="space-y-2 mt-4">
                  ...
                  <p className="text-[11px] text-slate-500 leading-relaxed whitespace-pre-line m-0">{sec.content}</p>
