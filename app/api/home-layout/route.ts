    ...
    if (!layout) {
      const defaultLayout = {
        ...
        sections: [
          ...
          { id: 'technology-section', title: 'Tech Pulse', isVisible: true, categorySource: 'Technology', order: 6, limit: 4, designStyle: 'grid', colorTheme: 'indigo', settings: {} },
          { id: 'trending-columns', title: 'Trending Columns', isVisible: true, categorySource: 'All', order: 7, limit: 5, designStyle: 'list', colorTheme: 'indigo', settings: {} },
          { id: 'world-affairs', title: 'World Affairs', isVisible: true, categorySource: 'World', order: 8, limit: 5, designStyle: 'grid', colorTheme: 'indigo', settings: {} },
          { id: 'arts-marketing-pr', title: 'Culture & Press Spotlight', isVisible: true, categorySource: 'Entertainment,Sports', order: 9, limit: 6, designStyle: 'spotlight-grid', colorTheme: 'indigo', settings: {} },
          { id: 'latest-news', title: 'The Latest Chronicle Feed', isVisible: true, categorySource: 'All', order: 10, limit: 10, designStyle: 'list', colorTheme: 'indigo', settings: {} }
        ]
      }
