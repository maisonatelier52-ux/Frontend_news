...
const DEFAULT_ABOUT_US = {
  title: 'About Us',
  subtitle: 'Who We Are',
  leadParagraph: 'Magazine Gazette is an independent digital news platform committed to delivering accurate, unbiased, and timely reporting across politics, business, technology, sports, and global affairs.',
  ...
  ownershipContent: 'Magazine Gazette operates independently and is not affiliated with any political party, corporation, or government entity. Our newsroom decisions are guided solely by journalistic integrity and public interest.',
  ...
  historyContent: 'Founded in 2020, Magazine Gazette began as a small team of journalists committed to filling gaps in local and national coverage. Since then, we have grown into a trusted platform serving readers across the globe.'
};
...
const DEFAULT_CONTACT_US = {
  ...
  departments: [
    { name: 'Editorial Team', description: 'For story tips, corrections, and general editorial inquiries.', email: 'editorial@magazinegazette.com' },
    { name: 'Advertising', description: 'For ad placements, sponsorships, and commercial partnerships.', email: 'ads@magazinegazette.com' },
    { name: 'Legal & Compliance', description: 'For legal notices, copyright issues, and compliance matters.', email: 'legal@magazinegazette.com' },
    { name: 'Technical Support', description: 'For website issues, accessibility concerns, and technical bugs.', email: 'tech@magazinegazette.com' }
  ]
};
...
const DEFAULT_PRIVACY_POLICY = {
  ...
  sections: [
    ...
    { heading: '5. Contact', intro: '', listItems: [], body: 'For privacy-related inquiries, please contact our Data Protection Officer at privacy@magazinegazette.com.' }
  ]
};
...
const DEFAULT_TERMS = {
  ...
  leadParagraph: 'By accessing or using Magazine Gazette, you agree to be bound by these Terms and Conditions. Please read them carefully.',
  sections: [
    ...
    { heading: '2. Intellectual Property', content: 'All content published on Magazine Gazette — including articles, images, graphics, and multimedia — is the intellectual property of Magazine Gazette or its respective content providers and is protected by applicable copyright law.', listItems: [] },
    ...
    { heading: '4. Disclaimer of Warranties', content: 'Magazine Gazette provides its services on an "as is" and "as available" basis without warranties of any kind. We do not guarantee the accuracy, completeness, or timeliness of any information published on our platform.', listItems: [] },
    { heading: '5. Limitation of Liability', content: 'To the fullest extent permitted by law, Magazine Gazette shall not be liable for any direct, indirect, incidental, special, or consequential damages arising out of or related to your use of the platform.', listItems: [] },
    { heading: '6. Changes to Terms', content: 'Magazine Gazette reserves the right to modify these Terms and Conditions at any time. Continued use of the platform following any changes constitutes your acceptance of the revised terms.', listItems: [] }
  ]
};
...
const DEFAULT_CORRECTION_POLICY = {
  ...
  leadParagraph: 'Magazine Gazette is committed to publishing accurate, fair, and truthful journalism. When errors occur, we correct them promptly and transparently.',
  sections: [
    ...
    { heading: 'Reporting an Error', content: 'If you believe you have found an error in any of our published content, please contact our editorial desk at corrections@magazinegazette.com with the article link and a description of the error.', listItems: [] }
  ]
};
...
const DEFAULT_ADVERTISING_POLICY = {
  ...
  leadParagraph: 'Magazine Gazette accepts advertising and sponsored content under strict editorial guidelines to ensure our journalism remains independent and our readers\' trust is maintained.',
  sections: [
    ...
    { heading: 'Ad Slots Booking', content: 'If you are interested in booking ad slots (such as our Header Banner, Sidebar slots, or custom placements), please contact our advertising desk at ads@magazinegazette.com.', listItems: [] }
  ]
};
...
const DEFAULT_OWNERSHIP_FUNDING = {
  ...
  leadParagraph: 'Magazine Gazette is committed to full transparency regarding our ownership structure, funding sources, and financial relationships that could affect our journalism.',
  sections: [
    { heading: 'Ownership Structure', content: 'Magazine Gazette is an independently owned digital media company. It is not affiliated with any political party, government entity, or large corporate conglomerate.', listItems: [] },
...
const DEFAULT_RIGHT_OF_REPLY = {
  ...
  leadParagraph: 'Magazine Gazette upholds the journalistic principle that individuals, organizations, or groups directly referenced in our reporting have the right to provide a response.',
  sections: [
    ...
    { heading: 'How to Submit a Reply', content: 'To submit a right of reply, please email reply@magazinegazette.com with the article title, publication date, the specific claims you wish to address, and your response.', listItems: [] },
...
const DEFAULT_LEGAL_POLICY = {
  ...
  leadParagraph: 'This legal policy governs your use of Magazine Gazette and outlines our disclaimers, intellectual property rights, and governing jurisdiction.',
  sections: [
    { heading: '1. Copyright Notice', content: 'All content on Magazine Gazette is protected by copyright law. Reproduction or distribution without written permission is prohibited.', listItems: [] },
    { heading: '2. Defamation & Libel', content: 'Magazine Gazette is committed to responsible journalism. If you believe content published on our platform is defamatory, contact legal@magazinegazette.com immediately.', listItems: [] },
    { heading: '3. Disclaimer of Endorsements', content: 'Reference to any commercial products, services, or trade names does not constitute endorsement by Magazine Gazette.', listItems: [] },
    { heading: '4. Governing Law and Jurisdiction', content: 'Any disputes arising out of or in connection with the use of Magazine Gazette shall be governed by the laws of the District of Columbia, United States.', listItems: [] }
  ]
};
